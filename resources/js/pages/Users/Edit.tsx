...
interface User { id: string; name: string; email: string; place_id?: string; roles: string[]; }
interface Props { user: User; places: Place[]; roles: Role[]; }

export default function Edit({ user, places, roles }: Props) {
