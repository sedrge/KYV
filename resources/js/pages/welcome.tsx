...
export default function Welcome({
    ...
    return (
        <>
            ...
            <div className="flex min-h-screen flex-col items-center bg-[#FDFDFC] px-4 py-6 text-[#1b1b18] sm:px-6 lg:justify-center lg:px-8 dark:bg-[#0a0a0a]">
                <header className="mb-4 w-full max-w-[335px] text-sm not-has-[nav]:hidden sm:mb-6 lg:max-w-4xl">
                ...
                <div className="flex w-full items-center justify-center opacity-100 transition-opacity duration-750 lg:grow starting:opacity-0">
                    <main className="flex w-full max-w-[335px] flex-col-reverse sm:max-w-md lg:max-w-4xl lg:flex-row">
                        <div className="flex-1 rounded-br-lg rounded-bl-lg bg-white p-4 pb-8 text-[13px] leading-[20px] shadow-[inset_0px_0px_0px_1px_rgba(26,26,0,0.16)] sm:p-6 sm:pb-12 lg:rounded-tl-lg lg:rounded-br-none lg:p-12 xl:p-20 dark:bg-[#161615] dark:text-[#EDEDEC] dark:shadow-[inset_0px_0px_0px_1px_#fffaed2d]">
                            <h1 className="mb-1 text-base font-medium sm:text-lg">
                                Let's get started
                            </h1>
                            ...
                            <ul className="mb-4 flex flex-col sm:mb-6 lg:mb-6">
                            ...
                            <ul className="flex flex-wrap gap-3 text-sm leading-normal">
                                <li>
                                    <a
                                        ...
                                        target="_blank"
                                        className="inline-block rounded-sm border border-black bg-[#1b1b18] px-4 py-1.5 text-sm leading-normal text-white hover:border-black hover:bg-black sm:px-5 dark:border-[#eeeeec] dark:bg-[#eeeeec] dark:text-[#1C1C1A] dark:hover:border-white dark:hover:bg-white"
                                    >
                                        Deploy now
                                    </a>
                                </li>
                        ...
                        <div className="relative -mb-px aspect-[335/376] w-full shrink-0 overflow-hidden rounded-t-lg bg-[#fff2f2] sm:aspect-[400/376] lg:mb-0 lg:-ml-px lg:aspect-auto lg:w-[438px] lg:rounded-t-none lg:rounded-r-lg dark:bg-[#1D0002]">
                            <svg
                                className="w-full max-w-none translate-y-0 scale-90 text-[#F53003] opacity-100 transition-all duration-750 sm:scale-100 dark:text-[#F61500] starting:translate-y-6 starting:opacity-0"
                                viewBox="0 0 438 104"
                                fill="none"
                                xmlns="http://www.w3.org/2000/svg"
                            >
                            ...
                            <svg
                                className="relative -mt-[4rem] -ml-6 w-full max-w-none scale-95 sm:-mt-[4.9rem] sm:-ml-8 sm:w-[448px] sm:scale-100 lg:-mt-[6.6rem] lg:ml-0 dark:hidden"
                                viewBox="0 0 440 376"
                                fill="none"
                                xmlns="http://www.w3.org/2000/svg"
                            >
                            ...
                            <svg
                                className="relative -mt-[4rem] -ml-6 hidden w-full max-w-none scale-95 sm:-mt-[4.9rem] sm:-ml-8 sm:w-[448px] sm:scale-100 lg:-mt-[6.6rem] lg:ml-0 dark:block"
                                viewBox="0 0 440 376"
                                fill="none"
                                xmlns="http://www.w3.org/2000/svg"
                            >
