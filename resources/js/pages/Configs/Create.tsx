...
import { index, store } from '@/actions/App/Http/Controllers/ConfigController';
            ...
            <div className="flex h-full flex-1 flex-col gap-4 p-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-muted-foreground">Créer une nouvelle configuration</p>
                    </div>
                </div>
                <Card>
                    <CardHeader>
                        <CardTitle>Informations de la configuration</CardTitle>
                        <CardDescription>Renseignez les informations de la nouvelle configuration</CardDescription>
                    </CardHeader>
                    <CardContent>
                        <Form {...store.form()}>
                            {({ errors, processing }) => (
