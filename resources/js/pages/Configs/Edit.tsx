...
function SettingField({ field, errors, config }: { field: Field; errors: Record<string, string>; config: Config }) {
    const getValue = (fieldName: string) => {
        ...
        return config.content?.[fieldName] || field.defaultValue;
    };
            ...
            <div className="flex items-start gap-3 py-3 border-b border-border/40 last:border-0">
                <div className="flex-1">
                    <div className="flex items-center gap-2">
                        <Checkbox id={field.name} name={field.name} defaultChecked={value === true || value === 'true' || value === '1'} />
    ...
    if (field.type === 'select') {
        return (
            <div className="flex items-start gap-4 py-3 border-b border-border/40 last:border-0">
                ...
                <div className="w-64">
                    <Select name={field.name} defaultValue={getValue(field.name)?.toString()}>
...
export default function Edit({ config, places }: { config: Config; places: Place[] }) {
